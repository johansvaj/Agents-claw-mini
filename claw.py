#!/usr/bin/env python3
"""
🤖⚡ Agents Claw Mini v6.1 - AI Terminal Controller via Telegram
Fix: Conflict error, proper cleanup, single instance only
"""
...
def header():
    return "\n".join([
        ...
        color("cyan") + "  ║" + color("dim") + "         AI Terminal Controller via Telegram v6.1        " + color("reset") + color("cyan") + "║",
        color("cyan") + "  ╚" + "═" * 62 + "╝" + color("reset"),
        "",
    ])
